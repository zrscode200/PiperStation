...
Ralph is prompt and skill behavior in {{RUNTIME_NAME}}. It is not a shell
runner. Use this skill after a task is clear or
`projects/<id>/work/task-queue.md` is ready.

## Preflight

1. Read `{{INSTRUCTION_DOC}}`, `STATION.md`, and the active project record:
...
The main {{RUNTIME_SESSION}} stays responsible for the work. Verify each
