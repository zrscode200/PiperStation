# Historical Codex-only distribution evidence

This is the distribution/wiring note from source commit b0e9934, retained on
2026-09-08 as historical evidence. Its Codex-only scope and migration commands
describe that release; current runtime/install guidance is in
[the capability matrix](capability-matrix.md). These earlier observations have
not been revalidated for Claude Code or Copilot CLI.
