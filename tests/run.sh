...
assert_contains "$codex_hub/AGENTS.md" "is routine and path-scoped"
assert_contains "$codex_hub/AGENTS.md" "Routine actions proceed when the workflow reaches them"
assert_contains "$codex_hub/AGENTS.md" "the only Piper-level asks"
assert_contains "$codex_hub/AGENTS.md" "Action classes"
assert_contains "$codex_hub/AGENTS.md" "never a go-ahead"
assert_contains "$codex_hub/AGENTS.md" "holds standing policy notes only"
assert_contains "$codex_hub/AGENTS.md" "approval_policy"
assert_contains "$codex_hub/AGENTS.md" "If writable access is"
assert_contains "$codex_hub/AGENTS.md" "## Action Boundaries"
...
assert_contains "$codex_hub/.codex/agents/implementer.toml" "Edit only inside the lane's checkout path the coordinator delegated"
...
assert_contains "$claude_hub/CLAUDE.md" "Action Boundaries"
assert_not_contains "$claude_hub/CLAUDE.md" "Permission Profiles"
assert_contains "$claude_hub/CLAUDE.md" "Routine actions proceed when the workflow reaches them"
assert_contains "$claude_hub/CLAUDE.md" "the only Piper-level asks"
assert_contains "$claude_hub/CLAUDE.md" "never a go-ahead"
assert_contains "$claude_hub/CLAUDE.md" "holds standing policy notes only"
assert_contains "$claude_hub/CLAUDE.md" "settings.json"
assert_contains "$claude_hub/CLAUDE.md" "If writable access is absent"
assert_not_contains "$claude_hub/CLAUDE.md" "profile coverage"
...
assert_contains "$claude_hub/.claude/agents/implementer.md" "lane's checkout path"
assert_contains "$claude_hub/.claude/agents/implementer.md" "perform these yourself"
assert_not_contains "$claude_hub/.claude/agents/implementer.md" "profile coverage"
...
assert_contains "$opencode_hub/AGENTS.md" "Action classes"
assert_not_contains "$opencode_hub/AGENTS.md" "Permission profiles"
assert_contains "$opencode_hub/AGENTS.md" "Routine actions proceed when the workflow reaches them"
assert_contains "$opencode_hub/AGENTS.md" "the only Piper-level asks"
assert_contains "$opencode_hub/AGENTS.md" "## Action Boundaries"
assert_contains "$opencode_hub/AGENTS.md" "never a go-ahead"
assert_contains "$opencode_hub/AGENTS.md" "holds standing policy notes only"
assert_contains "$opencode_hub/AGENTS.md" "\`permission\` config"
assert_contains "$opencode_hub/AGENTS.md" "If writable access is absent"
assert_not_contains "$opencode_hub/AGENTS.md" "profile coverage"
...
assert_contains "$opencode_hub/.opencode/agents/implementer.md" "lane's checkout path"
assert_contains "$opencode_hub/.opencode/agents/implementer.md" "perform these yourself"
assert_not_contains "$opencode_hub/.opencode/agents/implementer.md" "profile coverage"
...
assert_contains "$deepagent_hub/.deepagents/AGENTS.md" "Routine actions proceed when the workflow reaches them"
assert_contains "$deepagent_hub/.deepagents/AGENTS.md" "the only Piper-level asks"
assert_contains "$deepagent_hub/.deepagents/AGENTS.md" "Action classes"
assert_contains "$deepagent_hub/.deepagents/AGENTS.md" "## Action Boundaries"
assert_contains "$deepagent_hub/.deepagents/AGENTS.md" "Manual approval mode"
assert_contains "$deepagent_hub/.deepagents/AGENTS.md" "never a go-ahead"
assert_contains "$deepagent_hub/.deepagents/AGENTS.md" "holds standing policy notes only"
assert_contains "$deepagent_hub/.deepagents/AGENTS.md" "go-ahead exists in chat"
assert_contains "$deepagent_hub/.deepagents/AGENTS.md" "If writable access is absent"
assert_not_contains "$deepagent_hub/.deepagents/AGENTS.md" "Permission profiles"
assert_not_contains "$deepagent_hub/.deepagents/AGENTS.md" "profile coverage"
...
assert_contains "$deepagent_hub/.deepagents/agents/implementer/AGENTS.md" "lane's checkout path"
assert_contains "$deepagent_hub/.deepagents/agents/implementer/AGENTS.md" "perform these yourself"
assert_not_contains "$deepagent_hub/.deepagents/agents/implementer/AGENTS.md" "profile coverage"
...
for hub in "$codex_hub" "$claude_hub" "$opencode_hub" "$deepagent_hub"; do
  ...
  assert_contains "$hub/automation-policy.md" "no ask, no record"
...
for skill_dir in "$codex_hub/.codex/skills" "$claude_hub/.claude/skills" "$opencode_hub/.opencode/skills" "$deepagent_hub/.deepagents/skills"; do
  ...
  assert_contains "$skill_dir/piper-workflow/SKILL.md" "standing policy notes"
