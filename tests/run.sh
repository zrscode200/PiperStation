...
assert_contains "$codex_hub/.codex/skills/piper-workflow/references/compact-handoff.md" "Group-level review state"
...
assert_contains "$claude_hub/.claude/commands/compact-handoff.md" "Group-level review state"
...
assert_contains "$opencode_hub/.opencode/commands/compact-handoff.md" "Group-level review state"
