...
assert_contains "$claude_hub/.claude/commands/superpowers.md" "current problem, goals"
assert_contains "$claude_hub/.claude/commands/superpowers.md" "established docs location"
...
assert_contains "$opencode_hub/.opencode/commands/superpowers.md" "current problem, goals"
assert_contains "$opencode_hub/.opencode/commands/superpowers.md" "established docs location"
