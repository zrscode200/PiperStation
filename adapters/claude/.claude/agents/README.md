...
lists and by explicit no-edit instructions. The verifier role is the no-edit
runtime checker; the tester role is writable only when the coordinator
explicitly delegates test-layer files.
